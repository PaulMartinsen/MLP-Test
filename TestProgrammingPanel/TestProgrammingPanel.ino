/*
 Name:		TestProgrammingPanel.ino
 Created:	1/1/2018 12:19:08 PM
 Author:	Paul
*/
#include "MLPLib/MegunoLink.h"
...
{
  Serial.begin(9600);
  Serial.println(F("Test Programming Panel"));
  Serial.println(F("======================"));
...
void loop() 
{
  Test.Pass("Test 3", nCounter);
  Test.Fail("Test 4", nCounter);
  ++nCounter;
